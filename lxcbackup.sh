...
# 14 Dec 2018  knightmare  Updated with ISO date format YYYY-MM-DD-HH:MM & comments     #
#                                                                                       #
#---------------------------------------------------------------------------------------#
...
main () {
    ...
    ## TODO: this can flub and stil think it executed OK. Troubleshoot
